    ...
    return [
        {
            ...
            "N_E1": np.random.randint(
                1, 25
            ),  # nombre de entrepreneurs dans le secteur productif 1
            "N_E2": np.random.randint(
                1, 25
            ),  # nombre de entrepreneurs dans le secteur productif 2
            "N_W1": np.random.randint(
                1, 25
            ),  # nombre de salaries dans le secteur productif 1
            "N_W2": np.random.randint(
                1, 25
            ),  # nombre de salaries dans le secteur productif 2
            "N_WG": np.random.randint(
                1, 25
            ),  # nombre de salaries dans le secteur public
            "N_U": np.random.randint(
                1, 25
            ),  # nombre de chomeurs dans le secteur public
            "N_B": np.random.randint(1, 10),  # nombre de banques
            "phi1": np.random.uniform(
                0.5, 2.5
            ),  # productivite initial du secteur productif 1
            "phi2": np.random.uniform(
                0.5, 2.5
            ),  # productivite initial du secteur productif 2
