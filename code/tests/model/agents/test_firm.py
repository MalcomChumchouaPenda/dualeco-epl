...
@pytest.mark.parametrize(
    "Q, y, y_inv", [(110, 4, 5), (100, 4, 5), (110, 6, 5), (100, 6, 5)]
)
...
@pytest.mark.parametrize(
    "Q, y, y_inv", [(90, 6, 5), (80, 6, 5), (90, 7, 5), (80, 7, 5)]
)
...
@pytest.mark.parametrize(
    "Q, y, y_inv", [(90, 4, 5), (80, 3, 5), (90, 3, 5), (80, 2, 5)]
)
...
@pytest.mark.parametrize(
    "Q, y, y_inv, y_star",
    [(100, 4, 5, 10.625), (90, 4, 5, 7.5), (100, 6, 5, 10.625), (90, 6, 5, 4.375)],
)
...
@pytest.mark.parametrize(
    "Q, y, y_inv, Pr, N, p_Y",
    [(90, 4, 5, 0, 10, 2), (90, 6, 5, 0, 10, 1.75), (100, 6, 5, 0, 10, 2.25)],
)
...
@pytest.mark.parametrize(
    "D, M, L_d", [(50, 50, 0), (0, 50, 50), (50, 0, 50), (100, 50, 0)]
)
...
@pytest.mark.parametrize("N_star, Delta_N", [(3, 2), (3.5, 1), (4.5, 0), (5, 0)])
...
@pytest.mark.parametrize(
    "y_inv, phi", [(0, 1), (1, 1), (1, 1.5)]  # no inventory  # inventory
)  # larger productivity
